Shader "DaulerPalhares/Water v2" 
{
	Properties
	{
		_Color("Color", Color) = (0, 0.61, 1, 1)
		_SpecColor("Specular Material Color", Color) = (0.84, 0.96, 1, 1)
	...
	SubShader
	{
		Tags { "Queue" = "Transparent" "RenderType" = "Transparent" } //"Geometry" "RenderType" = "Opaque" } 
		Cull Off
		ZWrite On
